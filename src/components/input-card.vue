...
<template>
  <div
    class="h-60 w-full bg-white drop-shadow-lg rounded-3xl p-5 flex flex-col justify-between"
  >
    <p class="font-bold">Hint: {{ "Your hint" }}</p>
    <input
      type="text"
    ...
    <div class="flex justify-between">
      ...
      <div class="hidden md:block">{{ "notification" }}</div>
      <button
